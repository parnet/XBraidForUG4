...
#ifndef UG_PLUGIN_XBRAIDFORUG4_BRAID_SETTINGS_H
#define UG_PLUGIN_XBRAIDFORUG4_BRAID_SETTINGS_H
...
namespace ug { namespace XBraidForUG4 {
        ...
        public:
            ...
            virtual ~BraidSettings() = default;

            //----------------------------------------------------------------------------------------------------------
        };
    }
}
#endif //UG_PLUGIN_XBRAIDFORUG4_BRAID_SETTINGS_H
