//todo check
#ifndef UG_PLUGIN_XBRAIDFORUG4_BRAID_VECTOR_STRUCT_H
#define UG_PLUGIN_XBRAIDFORUG4_BRAID_VECTOR_STRUCT_H
...
#endif //UG_PLUGIN_XBRAIDFORUG4_BRAID_VECTOR_STRUCT_H
