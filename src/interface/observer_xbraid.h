#ifndef UG_PLUGIN_XBRAIDFORUG4_XBRAID_OBSERVER_H
#define UG_PLUGIN_XBRAIDFORUG4_XBRAID_OBSERVER_H
...
namespace ug { namespace XBraidForUG4 {
    ...
    public:
        ...
        IXBraidTimeIntegratorObserver() {};

        ~IXBraidTimeIntegratorObserver() override {};
         ...
         * @return
         */
        virtual bool step_process(SP_GridFunction u, int index, number time, number dt) override = 0;
...
#endif //UG_PLUGIN_XBRAIDFORUG4_XBRAID_OBSERVER_H
