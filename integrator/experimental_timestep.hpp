#ifndef UGPLUGIN_XBRAIDFORUG4_INTEGRATOR_EXTERNAL_TIMESTEP_H
#define UGPLUGIN_XBRAIDFORUG4_INTEGRATOR_EXTERNAL_TIMESTEP_H
...
namespace ug{ namespace xbraid {
    ...
    class ExperimentalTimeStep : public IResidualTimeIntegrator<TDomain, TAlgebra> {
    public:
        //--------------------------------------------------------------------------------------------------------------
        ...
        ExperimentalTimeStep() : IResidualTimeIntegrator<TDomain, TAlgebra>() {}
        ~ExperimentalTimeStep() override = default;
